...
<html lang="en">
    ...
    <body class="bg-[#f6f6f6]">
        ...
        <div class="flex flex-col w-full h-auto items-center justify-start pt-5">
            <div class="w-11/12">
                <ul class="flex flex-row items-center justify-between w-2/5 gap-2 py-4 px-2 bg-blue rounded-lg">
                    <li>
                        <a href="repair.jsp" class="font-medium p-3 cursor-pointer  bg-white text-blue transition rounded-lg">Bảo trì xe</a>
                    </li>
                    <li>
        ...
        <div class="flex flex-col w-full h-auto items-center justify-start pt-5">
            <div class="w-11/12 ">
                <p class="text-xl font-medium">THÊM PHIẾU BẢO TRÌ</p>
                <div class="bg-[#F4EBD9] p-5 mt-5 rounded-lg">
                    <div class=" flex flex-row gap-10">
                        ...
                        <div class="w-1/3">
                            <p class="text-base font-medium">Ngày bảo trì</p>
                            <input 
                                id="ngayBaoTriInput"
                                type="date"
                                class="mt-1 w-full h-12 text-base  text-black rounded-lg outline-none placeholder-black px-3"
                        ...
                        <div class="w-1/3">
                            <p class="text-base font-medium">Giá bảo trì</p>
                            <input 
                                id="giaBaoTri"
                                type="text"
                                class="mt-1 w-full h-12 text-base  text-black rounded-lg outline-none placeholder-black px-3"
                    ...
                    <div class="w-full mt-5 flex justify-center">
                        <button onclick="addMaintenance()" class="h-12 w-1/6 cursor-pointer bg-blue text-white  rounded-lg">
    ...
    <script src="../js/repair_v2.js"></script>
</html>
